...
public class TreetableController implements Initializable {
    ...
    public void remplirtable(){
        ...
        couche = mysig.get(combo_selected.getValue());
    ...
    public void addColonne() {
        ...
        CheckBox perimetre = new CheckBox("longeur");
        CheckBox surface = new CheckBox("surface");
        ...
        valider.setOnAction(e -> {
           ...
           /* if (surface.isSelected()){
                for (int i=0;i<myarraylist.size();i++){
                    ...
                    table.addtocol(name.getText(),(String)couche.getShape());
                    table.addtocol(name.getText(),myarraylist.get(i).getText());
                }
            }
            else if (perimetre.isSelected()){
        ...
        grid.add(name, 1, 0);
        grid.add(vbox,0,1);
        grid.add(perimetre,2,2);
        grid.add(surface,2,3);
