...
public class Principale2Controller  {
    ...
    private static final double maxWidth = 930;
    ...
    public void initialize(){
        ...
        scroll_display.setPrefSize(maxWidth, maxHeight);
        scroll_display.setMaxSize(maxWidth, maxHeight);
    ...
    public  void loadMap(){
        ...
        if(maxWidth/ratio < maxWidth) {
            displayedWidth=maxWidth;
            displayedHeight=(int) (displayedWidth/ratio);
        }else if(maxWidth*ratio < maxWidth){
            displayedHeight = maxWidth;
    ...
    public void selectMap() {
        ...
        Label nameLabel = new Label("Nom du Sig : ");
        TextField name = new TextField();
        name.setPrefWidth(350);

        Label hint = new Label("Selectionner l'image du fond : ");
        ...
        open.setOnAction(e -> {
            ...
            path = URL.getText();
            sigName = name.getText();

            if (path.equals("")) return;
            if (sigName.equals("")) return;
        ...
        initialScene = new Scene(grid, 650, 150);
